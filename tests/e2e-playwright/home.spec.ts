...
test.describe('Home Page', () => {
  test('should load home page and display hero section', async ({ page }) => {
    ...
    await expect(page.getByText('Zapatillas que respetan el planeta')).toBeVisible();
    await expect(page.getByText('Descubre nuestra colección de zapatillas sostenibles')).toBeVisible();
  });
  ...
  test('should display featured products section', async ({ page }) => {
    ...
    await expect(page.getByText('Nuestras zapatillas más populares')).toBeVisible();
  });

  test('should navigate to products page when clicking "Ver Colección"', async ({ page }) => {
    await page.goto('/');
  ...
  test('should display features section', async ({ page }) => {
    ...
    await page.getByText('¿Por qué elegir nuestras zapatillas?').scrollIntoViewIfNeeded();
  ...
  test('should have proper meta tags', async ({ page }) => {
    ...
    // Check title
    await expect(page).toHaveTitle(/Zapatillas - Zapatillas Sostenibles y Cómodas/);
    
    // Check meta description
    const metaDescription = page.locator('meta[name="description"]');
    await expect(metaDescription).toHaveAttribute('content', /Descubre nuestra colección de zapatillas sostenibles/);
  });
  ...
  test('should be responsive on mobile', async ({ page }) => {
    ...
    const buttons = page.locator('a[href="/productos"], a[href="/sobre-nosotros"]');
