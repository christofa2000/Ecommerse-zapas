...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from--(----brand-50) to--(----brand-100) py-20">
      <div className="container-soft">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-square rounded--(----radius) bg-gradient-to-br from--(----brand-200) to--(----brand-300) p-8">
